...
class bulletin$14 extends Thread {
   // $FF: synthetic field
   final bulletin this$0;

   bulletin$14(final bulletin var1) {
      this.this$0 = this$0;
   }
      ...
      try {
         ...
         for(int i = 0; i < this.this$0.listTable.getRowCount(); ++i) {
            if ((Boolean)((ModelClass.tmBulletinPaie)this.this$0.listTable.getModel()).getValueAt(i, 0)) {
               ...
               if (paie != null) {
                  this.this$0.menu.gl.printReport(this.this$0.menu.paramsGen.getLicenceKey() != null && this.this$0.menu.paramsGen.getLicenceKey().equalsIgnoreCase("EX05L-P08WH-ZP20B-VPJGA") ? "bulletinPaie_imrop" : "bulletinPaie", this.this$0.setFichePaieParams(paie), !this.this$0.cPrinterDialog.isSelected());
                  ++valuePB;
                  this.this$0.progressBar1.setValue(valuePB);
               }
            }
